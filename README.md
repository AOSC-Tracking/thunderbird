...
7. Push the `tarball` branch and the tag just created to the remote (`git push --tags`).
...
11. Push the `aosc/v$VER` branch and the tag just created to the remote (`git push --tags`).
